...
/// App 进入后台模式通知
let appDidEnterBackgroundNotification = Notification.Name(rawValue: "applicationDidEnterBackground")
/// App 将要进入前台通知
let appWillEnterForegroundNotification = Notification.Name("applicationWillEnterForeground")
